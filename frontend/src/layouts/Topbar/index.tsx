...
// images
import logoSm from '../../assets/wd-assets/logo-white.png'
// import avatar1 from '../../assets/images/users/user-1.jpg'
import avatar1 from '../../assets/wd-assets/wd2.png'
// import avatar1 from '../../assets/wd-assets/logo-white.png'
import logoDark from '../../assets/wd-assets/logo-white.png'
import logoLight from '../../assets/wd-assets/logo-white.png'
      ...
      <div className={containerClass}>
        ...
        <div className="logo-box">
          ...
          <Link to="/" className="logo logo-light text-center">
            <span className="logo-sm">
              <img src={logoSm} alt="logo-sm" height="32" />
            </span>
            <span className="logo-lg">
