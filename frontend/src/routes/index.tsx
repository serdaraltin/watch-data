...
//camera setup
const CameraSetup = React.lazy(() => import('../pages/camera-setup'))
//cameras
  ...
  return useRoutes([
    ...
    },
    {
      ...
      children: [
        ...
        {
          path: 'editor',
          element: <LoadComponent component={Editor} />,
        },
        {
          path: 'notifications',
        ...
        {
          path: 'camera-setup',
          element: <LoadComponent component={CameraSetup} />,
        },
        {
          path: 'cameras',
          element: <LoadComponent component={Cameras} />,
        },
